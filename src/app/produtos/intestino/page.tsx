        ...
        <section style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Produtos naturais para melhorar a saúde intestinal, 
              fortalecer a microbiota e promover o bem-estar digestivo.
            </p>
          </div>
        </section>
            ...
            {loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '3rem' }}>
                ...
                <p style={{ color: '#666', fontSize: '1rem' }}>
                  Estamos preparando nossa linha de produtos para saúde intestinal. Em breve você encontrará aqui 
