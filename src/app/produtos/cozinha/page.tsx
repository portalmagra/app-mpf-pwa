  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        ...
        const products = await productService.getProductsByCategory('cozinha')
        ...
        <section style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Utensílios, eletrodomésticos e acessórios para uma cozinha 
            ...
            {loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '3rem' }}>
                ...
                <p style={{ color: '#666', fontSize: '1rem' }}>
                  Estamos preparando nossa linha de produtos para cozinha. Em breve você encontrará aqui 
