  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        ...
        const products = await productService.getProductsByCategory('hormonal')
        ...
        <section style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Produtos naturais para equilibrar hormônios, melhorar o ciclo menstrual 
              e promover o bem-estar feminino e masculino.
            </p>
          </div>
        </section>
            ...
            {loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '3rem' }}>
                ...
                <p style={{ color: '#666', fontSize: '1rem' }}>
                  Estamos preparando nossa linha de produtos para equilíbrio hormonal. Em breve você encontrará aqui 
