        ...
        <section style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Suplementos e produtos naturais para aumentar energia, 
              melhorar disposição e combater o cansaço.
            </p>
          </div>
        </section>
            ...
            {loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '3rem' }}>
                ...
                <p style={{ color: '#666', fontSize: '1rem' }}>
                  Estamos preparando nossa linha de produtos para energia e disposição. Em breve você encontrará aqui 
