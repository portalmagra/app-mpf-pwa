        ...
        <section style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Cafés especiais, chás funcionais e bebidas saudáveis para 
              energizar seu dia com sabor e qualidade.
            </p>
          </div>
        </section>
            ...
            {loading ? (
              ...
              <div style={{ textAlign: 'center', padding: '3rem' }}>
                ...
                <p style={{ color: '#666', fontSize: '1rem' }}>
                  Estamos preparando nossa linha de cafés e bebidas. Em breve você encontrará aqui 
