...
const getRecipeEmoji = (nome: string): string => {
  ...
  if (nomeLower.includes('sopa') || nomeLower.includes('soup')) return '🍲'
  if (nomeLower.includes('caldo') || nomeLower.includes('broth')) return '🥣'
  if (nomeLower.includes('creme') || nomeLower.includes('cream')) return '🥄'
  if (nomeLower.includes('tomate') || nomeLower.includes('tomato')) return '🍅'
  if (nomeLower.includes('abóbora') || nomeLower.includes('pumpkin')) return '🎃'
  ...
  if (nomeLower.includes('lentilha') || nomeLower.includes('lentil')) return '🫘'
  if (nomeLower.includes('feijão') || nomeLower.includes('bean')) return '🫘'
...
export default function SopasFuncionaisPage() {
  ...
  useEffect(() => {
    ...
    const loadRecipes = async () => {
      try {
        console.log('🔄 Carregando receitas Sopas Funcionais do Supabase...')
        ...
        const convertedRecipes: Receita[] = supabaseRecipes
          .filter((recipe: Recipe) => 
            ...
            recipe.name.toLowerCase().includes('creme') ||
        ...
        console.log('✅ Receitas Sopas Funcionais convertidas:', convertedRecipes)
        setReceitas(convertedRecipes)
        setFilteredReceitas(convertedRecipes)
        setLoading(false)
      } catch (error) {
        console.error('❌ Erro ao carregar receitas Sopas Funcionais do Supabase:', error)
        ...
        const mockReceitas: Receita[] = [
          {
            ...
            tipo: "gratuita",
            preco: 0,
            link_pdf: "https://drive.google.com/file/d/sopa-anti/view",
            status: "ativa",
            data_criacao: "2024-01-15",
            categoria: "sopas-funcionais"
          },
          {
            id: 2,
            nome: "Creme de Abóbora Funcional",
            descricao: "Sopa cremosa rica em betacaroteno e vitaminas",
            tipo: "gratuita",
            preco: 0,
            link_pdf: "https://drive.google.com/file/d/creme-abobora/view",
            status: "ativa",
          ...
          {
            id: 3,
            nome: "Sopa de Lentilha Detox",
            descricao: "Sopa nutritiva com proteínas vegetais e fibras",
            tipo: "gratuita",
            preco: 0,
            link_pdf: "https://drive.google.com/file/d/sopa-lentilha/view",
            status: "ativa",
      ...
      <main className="max-w-sm mx-auto px-4 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-brand-text2 mt-2">
            Sopas nutritivas e reconfortantes
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <input
            type="text"
            placeholder="Buscar sopas funcionais..."
            value={searchTerm}
        ...
        {loading && (
          <div className="text-center py-8">
            ...
            <p className="text-brand-text2">Carregando sopas funcionais...</p>
          </div>
        )}
        ...
        {!loading && (
          <div className="space-y-4">
            {filteredReceitas.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-brand-text2">Nenhuma sopa funcional encontrada.</p>
              </div>
            ) : (
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        >
                          {receita.tipo === 'gratuita' ? 'Ver Sopa' : 'Comprar'}
                        </button>
                      </div>
