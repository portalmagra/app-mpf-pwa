...
export default function DocesFitPage() {
  ...
  useEffect(() => {
    ...
    const loadRecipes = async () => {
      try {
        console.log('🔄 Carregando receitas Doces Fit do Supabase...')
        ...
        const convertedRecipes: Receita[] = supabaseRecipes
          .filter((recipe: Recipe) => 
            ...
            recipe.name.toLowerCase().includes('fit')
          )
          .map((recipe: Recipe) => ({
            id: recipe.id,
            nome: recipe.name,
        ...
        console.log('✅ Receitas Doces Fit convertidas:', convertedRecipes)
        setReceitas(convertedRecipes)
        setFilteredReceitas(convertedRecipes)
        setLoading(false)
      } catch (error) {
        console.error('❌ Erro ao carregar receitas Doces Fit do Supabase:', error)
        
        // Fallback para dados padrão em caso de erro
        const mockReceitas: Receita[] = [
          {
            id: 1,
            nome: "Brownie de Chocolate Fit",
            descricao: "Brownie saudável feito com cacau em pó e adoçante natural",
            tipo: "gratuita",
            preco: 0,
            link_pdf: "https://drive.google.com/file/d/brownie-fit/view",
            status: "ativa",
          ...
          },
          {
            id: 2,
            nome: "Pudim de Chia",
            descricao: "Pudim cremoso feito com sementes de chia e leite de coco",
            tipo: "gratuita",
            preco: 0,
            link_pdf: "https://drive.google.com/file/d/pudim-chia/view",
            status: "ativa",
    ...
    <div className="min-h-screen bg-brand-cream">
      ...
      <main className="max-w-sm mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <input
            type="text"
            placeholder="Buscar receitas doces..."
            value={searchTerm}
